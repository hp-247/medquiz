const data = [
  {
    id: "1",
    question:
      "An IV drug user is tested, and found positive, for infec- tion by HIV. If the patient is only placed on one antiviral medication, viral loads will initially be reduced, but will then rapidly increase. The resistance to the drug occurs due to which of the following?",
    incorrectAnswers: [
  ...
  },
  {
    id: "2",
    question:
      "A researcher needs to prepare RNA for Northern blot analysis. Initial experiments using total RNA produce no signal when the experiment is completed. A method to increase the sensitivity of the assay would be to do which of the following to the total RNA sample?",
    incorrectAnswers: [
  ...
  },
  {
    id: "3",
    question:
      "A researcher has obtained an antibody to cytosolic pro- tein X and runs a Western blot using as samples a vari- ety of tissue types. The results of the Western blot are shown below. A potential interpretation of the results is which of the following?",
    incorrectAnswers: [
  ...
  },
  {
    id: "4",
    question:
      "An individual having β-thalassemia minor exhibits two bands on a Northern blot using a probe against exon 1 of β-globin. The smaller band is of normal size and “heavier” than the other larger band, which consists of approximately 247 additional nucleotides. One expla- nation for this finding is which of the following?",
    incorrectAnswers: [
